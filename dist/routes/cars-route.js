...
carRouter.get('/search', car_controller_1.findCarByName);
carRouter.post('/create', car_controller_1.createCarController);
carRouter.put('/update', car_controller_1.updateCarController);
carRouter.delete('/delete', car_controller_1.deleteCarController);
