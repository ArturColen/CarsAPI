export default class Carro {
    ...
    constructor(id: number, nome: string, preco: string, cor: string, fabricante: string, categoria: string, anoLancamento: number, assentos: number, potencia: number, aro: number, versao: string, peso: number, abastecimento: string) {
        this._id = id;
        this._nome = nome;
        this._preco = preco;
        this._cor = cor;
